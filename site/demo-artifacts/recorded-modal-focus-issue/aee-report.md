...
| Status | completed |
| Started | 2026-09-02T18:01:37.560Z |
| Finished | 2026-09-02T18:01:38.170Z |
...
| Field | Value |
| --- | --- |
| Interaction ID | interaction:click:1788372097560 |
| Interaction | click |
| Target | button "Delete Project Alpha" |
| Checkpoint | public-demo-modal-focus-broken |
| URL | ./?recording=1&label=fixed&focus=broken |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| dom:before:1788372097563 | before | dom | ok | n/a | 1 | 0 | Captured DOM before state. |
| focus:before:1788372097564 | before | focus | ok | n/a | 1 | 0 | Captured focus before state (button #delete-project "Delete Project Alpha"). |
| visual:before:1788372097602 | before | visual | ok | n/a | 1 | 0 | Captured screenshot before state. |
| dom:after:1788372098133 | after | dom | ok | n/a | 1 | 1 | Captured DOM after state with observable markup changes. |
| focus:after:1788372098133 | after | focus | ok | n/a | 1 | 0 | Captured focus after state (button #delete-project "Delete Project Alpha"). |
| visual:after:1788372098163 | after | visual | ok | n/a | 1 | 0 | Captured screenshot after state. |

### Judgments

| ID | Verdict | Judge | Severity | Confidence | Evidence | Artifacts | Summary |
| --- | --- | --- | --- | --- | --- | --- | --- |
| focus-management:interaction:click:1788372097560 | fail | focus-management | high | 0.95 | 2 | 2 | Dialog opened, but focus remained outside it. Before: button #delete-project "Delete Project Alpha". After: button #delete-project "Delete Project Alpha". |
| change-response:interaction:click:1788372097560 | pass | change-response | info | 0.9 | 1 | 1 | Observed response signals after the click interaction (DOM changed). |
| release:interaction:click:1788372097560 | fail | release | high | 0.75 | 2 | 2 | Release gate failed because 1 blocking judgment met the current policy threshold. |

### Findings

| ID | Severity | Rule | Evidence | Artifacts | Message | Suggested Fix |
| --- | --- | --- | --- | --- | --- | --- |
| focus-management:interaction:click:1788372097560:dialog-focus-not-moved | high | dialog-initial-focus | 2 | 2 | The interaction opened a dialog but focus did not move inside it. | When the modal opens, move focus to an appropriate element inside it, such as its heading or least-destructive action. |
