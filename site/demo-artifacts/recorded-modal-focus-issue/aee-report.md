...
| Status | completed |
| Started | 2026-09-04T11:48:17.085Z |
| Finished | 2026-09-04T11:48:17.655Z |
...
| Field | Value |
| --- | --- |
| Interaction ID | interaction:click:1788522497084 |
| Interaction | click |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| dom:before:1788522497087 | before | dom | ok | n/a | 1 | 0 | Captured DOM before state. |
| focus:before:1788522497088 | before | focus | ok | n/a | 1 | 0 | Captured focus before state (button #delete-project "Delete Project Alpha"). |
| visual:before:1788522497104 | before | visual | ok | n/a | 1 | 0 | Captured screenshot before state. |
| focus:after:1788522497624 | after | focus | ok | n/a | 1 | 0 | Captured focus after state (button #delete-project "Delete Project Alpha"). |
| dom:after:1788522497625 | after | dom | ok | n/a | 1 | 1 | Captured DOM after state with observable markup changes. |
| visual:after:1788522497646 | after | visual | ok | n/a | 1 | 0 | Captured screenshot after state. |

### Judgments

| ID | Verdict | Judge | Severity | Confidence | Evidence | Artifacts | Summary |
| --- | --- | --- | --- | --- | --- | --- | --- |
| focus-management:interaction:click:1788522497084 | fail | focus-management | high | 0.95 | 2 | 2 | Dialog opened, but focus remained outside it. Before: button #delete-project "Delete Project Alpha". After: button #delete-project "Delete Project Alpha". |
| change-response:interaction:click:1788522497084 | pass | change-response | info | 0.9 | 1 | 1 | Observed response signals after the click interaction (DOM changed). |
| release:interaction:click:1788522497084 | fail | release | high | 0.75 | 2 | 2 | Release gate failed because 1 blocking judgment met the current policy threshold. |

### Findings

| ID | Severity | Rule | Evidence | Artifacts | Message | Suggested Fix |
| --- | --- | --- | --- | --- | --- | --- |
| focus-management:interaction:click:1788522497084:dialog-focus-not-moved | high | dialog-initial-focus | 2 | 2 | The interaction opened a dialog but focus did not move inside it. | When the modal opens, move focus to an appropriate element inside it, such as its heading or least-destructive action. |
