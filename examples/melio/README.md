...
The comparison also writes `manifest.json`, covering both lanes with relative evidence paths, SHA-256 checksums, per-action provenance, and privacy marked sensitive and unreviewed for sharing.
