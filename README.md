...
- Focus snapshots now include simple composite-widget metadata for roving keyboard patterns
- Keyboard judging now checks focus direction, tablist-style arrow-key navigation, and basic enter/space activation behavior
...
2. Expand composite-widget judging beyond simple roving-focus cases, including more arrow-key patterns and `aria-activedescendant`.
