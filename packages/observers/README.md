...
The visual observer captures separate viewport and full-page PNGs before and after an interaction. The axe observer preserves the complete axe 4.13 result for the cumulative WCAG 2.0, 2.1, and 2.2 A/AA tag selection. The portable virtual-reader observer writes canonical JSON and readable TXT transcripts while recording whether virtual navigation moved DOM focus. Guidepup remains a declared extension point.
